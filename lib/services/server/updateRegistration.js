...
function endUpdate(req, res) {
    return function (error, result) {
        if (error) {
            ...
            logger.debug('Update registration request ended successfully');
...
function updateRegister(req, queryParams, obj, callback) {
    logger.debug('Updating device register with lifetime [%s] and address [%s].', queryParams.lt, req.rsinfo.address);
